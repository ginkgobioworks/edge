...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Feature._qualifiers'
        db.add_column(u'edge_feature', '_qualifiers',
                      self.gf('django.db.models.fields.TextField')(null=True, db_column='qualifiers'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Feature._qualifiers'
        db.delete_column(u'edge_feature', 'qualifiers')
