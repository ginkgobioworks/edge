...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'edge_genome', 'parent_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['edge.Genome'], null=True, on_delete=models.PROTECT))

    def backwards(self, orm):

        # Changing field 'Genome.parent'
        db.alter_column(u'edge_genome', 'parent_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['edge.Genome'], null=True))
