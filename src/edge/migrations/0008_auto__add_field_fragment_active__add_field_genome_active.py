...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'edge_fragment', 'active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Genome.active'
        db.add_column(u'edge_genome', 'active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Fragment.active'
        db.delete_column(u'edge_fragment', 'active')

        # Deleting field 'Genome.active'
        db.delete_column(u'edge_genome', 'active')
