...
MANAGE_COMMANDS = build_edge_blastdb build_genome_blastdb export_gff import_gff remove_fragment remove_genome test
${MANAGE_COMMANDS}: args=
${MANAGE_COMMANDS}:
	${MANAGE} $@ ${args}
...
MAKE_EXT = docker-compose run --rm ${service_name} make -C ${EDGE_HOME}
